            ...
            FROM
                (
                    ...
                    WHERE
                        ...
                        AND traffic_type = 'users' AND site_name IS NOT NULL
                        AND industry_name = 'Gaming' AND site_id = 10071
...
const BETTER_PLAY_SPORTS = `
    SELECT
        last_week.industry_name,
        'BetterPlay - Sports' AS vertical,
        SUM(last_5_weeks.revenue) AS last_5_weeks, SUM(last_week.revenue) AS last_week
    FROM
        (
            SELECT
                industry_name,
